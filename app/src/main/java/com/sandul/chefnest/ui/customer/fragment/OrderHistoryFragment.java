    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    JsonObject jsonObject = NetworkUtils.makePostRequest("/load-user-order-history", "{email:\"" + email + "\"}");
                    ...
                    if (jsonObject.get("message").getAsString().equals("success")) {
                        ...
                        if (isAdded()) {
                            requireActivity().runOnUiThread(() -> {
                                RecyclerView recyclerView = requireView().findViewById(R.id.history_recyclerView);
        ...
        ImageView backBtn = view.findViewById(R.id.history_fragment_back);
