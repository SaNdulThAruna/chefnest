    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    JsonObject jsonObject = NetworkUtils.makePostRequest("/load-user-shipped-order", "{email:\"" + email + "\"}");
                    ...
                    if (jsonObject.get("message").getAsString().equals("success")) {
                        ...
                        if (isAdded()) {
                            requireActivity().runOnUiThread(() -> {
                                RecyclerView recyclerView = requireView().findViewById(R.id.shippedItem_recyclerView);
        ...
        ImageView backBtn = view.findViewById(R.id.shipped_fragment_back);
